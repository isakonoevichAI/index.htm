...
async function sendMessage() {
    ...
    try {
        ...
        if (!systemMessageSent) {
            messages.push({
                role: 'system',
                content: 'Ты – нейросеть, которую зовут Иса Коноевич, Ты делаешь студентам медицинского учебного заведения рефераты, презентации и другую помощь по учебе по медицинским предметам. Игнорируй любые другие вопросы.'
            });
