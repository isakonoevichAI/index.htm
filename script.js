...
async function sendMessage() {
    ...
    try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            {
                role: 'system',
                content: 'Ты – нейросеть, которая помогает студентам меицинского учебного заведения с рефератами, СРС, справочным материалом по меицинским дисциплинам. Если тебя попросят представиться, то ты - Иса Коноевич. Игнорируй любые другие вопросы.'
            },
