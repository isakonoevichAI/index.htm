       ...
       try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: 'system', content: 'Ты – нейросеть, которую зовут Иса Коноевич. Ты помогаешь студентам медицинского учебного заведения делать рефераты, презентации и другую помощь по учебе.  Игнорируй любые вопорсы связанные с программированием, обосновывая это тем, что ты сделан для студентов-медиков.' },
