...
async function sendMessage() {
    ...
    try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            {
                role: 'system',
                content: 'Ты – нейросеть, которая помогает студентам меицинского учебного заведения с рефератами, СРС, справочным материалом по меицинским дисциплинам. Игнорируй любые другие вопросы.'
            },
